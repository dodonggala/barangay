...
<head>
  <meta charset="UTF-8">
  <title>E-Transact for Barangay San Isidro Pamplona</title>
...
<style>
  .panel-default {
    -webkit-box-shadow: 10px 9px 15px -7px rgba(0,0,0,0.44);
-moz-box-shadow: 10px 9px 15px -7px rgba(0,0,0,0.44);
box-shadow: 10px 9px 15px -7px rgba(0,0,0,0.44);
  }
...
<body class="skin-black">
  ...
  <div class="container" style="margin-top: -7rem">
    <div class="col-md-4 col-md-offset-4">
      <div class="img" style="justify-content: center; display: flex; margin-bottom: 20px; margin-left: -7px;">
        <img src="pages/clearance/Isidro.png" alt="" style="object-fit: contain; aspect-ratio: 3/2; width: 20rem; ">
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-heading" style="text-align:center;">
          ...
          <h3 class="panel-title">
            <strong>
              E-Transact for Barangay San Isidro Pamplona
            </strong>
          </h3>
        </div>
