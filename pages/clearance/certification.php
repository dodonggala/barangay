...
?>
    <div class="clearance-container">
        ...
        <div class="letter-body">
            <p>This is to certify that <input type="text" value="<?php echo strtoupper($row['lname'] . ', ' . $row['fname'] . ' ' . $row['mname']); ?>" style="width: 40%;">, <input type="text" style="width: 40px;"> years old, <input type="text" style="width: 10%;">, Filipino, a resident of Barangay San Isidro, Pamplona, Negros Oriental.</p>
            ...
            <div class="form-check" style="display: flex; align-items: center; margin-left: 12%; margin-bottom: 7px;">
                <input class="form-check-input" type="checkbox" value="" style="width: 20px; height: 20px;" id="flexCheckDefault">
                <label class="form-check-label" for="flexCheckDefault">
                    This certification is issued to support for <input type="text" style="width: 39%;">
                </label>
            </div>
            <div class="form-check" style="display: flex; align-items: center; margin-left: 12%; margin-bottom: 7px">
                <input class="form-check-input" type="checkbox" value="" style="width: 20px; height: 20px;" id="flexCheckDefault">
