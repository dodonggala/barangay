                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input name="txt_householdno" class="form-control input-sm" type="number" placeholder="Household #" />
                            </div>
                            <div class="form-group">
                                <label>Sitio:</label>
                            ...
                            <div class="form-group">
                                ...
                                <input id="txt_hof" name="txt_hof" class="form-control input-sm" style="width:100%" >
                            </div>
                            <div class="form-group">
                                <label>Total Number of Members:</label>
                                <input id="txt_totalmembers" name="txt_totalmembers" class="form-control input-sm" type="text" placeholder="Total Number of Members" />
                            </div>
                        </div>
                    </div>
