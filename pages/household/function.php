...
if(isset($_POST['btn_save']))
{
    ...
    $update_query = mysqli_query($con,"UPDATE tblhousehold set householdno='".$householdno."', zone ='".$txt_edit_zone."', totalhouseholdmembers='".$totalhouseholdmembers."', totalhouseholdmembers='".$txt_edit_totalmembers."' where id = '".$txt_id."' ") or die('Error: ' . mysqli_error($con));
