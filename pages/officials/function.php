...
if(isset($_POST['btn_save']))
{
    ...
    $update_query = mysqli_query($con,"UPDATE tblofficial set sPosition='".$sPosition."', completeName = '".$txt_edit_cname."', pcontact = '".$txt_edit_contact."', paddress = '".$txt_edit_address."', termStart = '".$txt_edit_sterm."', termEnd = '".$txt_edit_eterm."' where id = '".$txt_id."' ") or die('Error: ' . mysqli_error($con));
