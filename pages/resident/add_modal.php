                            ...
                            <div class="container-fluid">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input name="txt_fname" class="form-control input-sm col-sm-4" type="text" placeholder="First name"/>
                                        </div>
                                        <div class="col-sm-4">
                                            <input name="txt_mname" class="form-control input-sm col-sm-4" type="text" placeholder="Middle name"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="txt_householdnum" class="form-control input-sm input-size" type="text" min="1" placeholder="Household #"/>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="txt_income" class="form-control input-sm" type="text" min="1" placeholder="Monthly Income"/>
                                    </div>
