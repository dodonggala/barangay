        ...
        <div class="modal-dialog modal-sm" style="width:300px !important;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Manage Sitio Representatives</h4>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Sitio Name:</label>
                                <input name="txt_zone" class="form-control input-sm" type="text" placeholder="Sitio" />
                            </div>
                            <div class="form-group">
                                <label>Name of Rep:</label>
                                <input name="txt_uname" class="form-control input-sm" id="username" type="text" placeholder="input name" />
                                <label id="user_msg" style="color:#CC0000;"></label>
                            </div>
                            <div class="form-group">
                                <label>Contact #:</label>
                                <input name="txt_pass" class="form-control input-sm" type="number" placeholder="+639" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary btn-sm" name="btn_add_new" value="Add" id="btn_add" />
                </div>
            </div>
        </div>
    </form>
